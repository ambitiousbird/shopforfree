                                ...
                                <Sidebar/>
                                	<div className="span9">
                                        ...
                                        <div className="row">	  
                                                ...
                                                <a href={require("../../components/images/products/large/f1.jpg")} title="Fujifilm FinePix S2950 Digital Camera">
                                                    <img src={require("../../components/images/products/large/3.jpg")} style={{width:"100%"}} alt="Fujifilm FinePix S2950 Digital Camera"/>
                                                </a>
                                                <div id="differentview" className="moreOptopm carousel slide">
                                                    <div className="carousel-inner">
                                                    <div className="item active">
                                                    <a href={require("../../components/images/products/large/f1.jpg")}> <img style={{width:"29%"}} src={require("../../components/images/products/large/f1.jpg")} alt=""/></a>
                                                    <a href={require("../../components/images/products/large/f2.jpg")}> <img style={{width:"29%"}} src={require("../../components/images/products/large/f2.jpg")} alt=""/></a>
                                                    <a href={require("../../components/images/products/large/f3.jpg")} > <img style={{width:"29%"}} src={require("../../components/images/products/large/f3.jpg")} alt=""/></a>
                                                    </div>
                                                    <div className="item">
                                                    <a href={require("../../components/images/products/large/f3.jpg")} > <img style={{width:"29%"}}src={require("../../components/images/products/large/f3.jpg")} alt=""/></a>
                                                    <a href={require("../../components/images/products/large/f1.jpg")}> <img style={{width:"29%"}} src={require("../../components/images/products/large/f1.jpg")} alt=""/></a>
                                            ...
                                            <div className="tab-content">
                                                <div className="tab-pane" id="listView">
                                                    <div className="row">	  
                                                        <div className="span2">
                                                            <img src={require("../../components/images/products/4.jpg")} alt=""/>
                                                        </div>
                                                        <div className="span4">
                                                            <h3>New | Available</h3>				
                                                            <hr className="soft"/>
                                                ...
                                                <div className="row">	  
                                                        <div className="span2">
                                                            <img src={require("../../components/images/products/5.jpg")} alt=""/>
                                                        </div>
                                                        <div className="span4">
                                                            <h3>New | Available</h3>				
                                                            <hr className="soft"/>
                                                ...
                                                <div className="row">	  
                                                        <div className="span2">
                                                        <img src={require("../../components/images/products/8.jpg")} alt=""/>
                                                        </div>
                                                        <div className="span4">
                                                            <h3>New | Available</h3>				
                                                            <hr className="soft"/>
                                                ...
                                                <hr className="soft"/>
                                                    <div className="row">	  
                                                        <div className="span2">
                                                        <img src={require("../../components/images/products/9.jpg")} alt=""/>
                                                        </div>
                                                        <div className="span4">
                                                            <h3>New | Available</h3>				
                                                            <hr className="soft"/>
                                            ...
                                            <div className="tab-pane active" id="blockView">
                                                <ul className="thumbnails">
                                                    ...
                                                    <div className="thumbnail">
                                                        <a href="product_details.html"><img src={require("../../components/images/products/10.jpg")} alt=""/></a>
                                                    ...
                                                    <li className="span3">
                                                    <div className="thumbnail">
                                                        <a href="product_details.html"><img src={require("../../components/images/products/11.jpg")} alt=""/></a>
                                                        <div className="caption">
                                                        <h5>Manicure &amp; Pedicure</h5>
                                                        <p> 
                                                            Lorem Ipsum is simply dummy text. 
                                                    ...
                                                    <li className="span3">
                                                    <div className="thumbnail">
                                                        <a href="product_details.html"><img src={require("../../components/images/products/12.jpg")} alt=""/></a>
                                                        <div className="caption">
                                                        <h5>Manicure &amp; Pedicure</h5>
                                                        <p> 
                                                            Lorem Ipsum is simply dummy text. 
                                                    ...
                                                    <li className="span3">
                                                    <div className="thumbnail">
                                                        <a href="/product_details"><img src={require("../../components/images/products/13.jpg")} alt=""/></a>
                                                        <div className="caption">
                                                        <h5>Manicure &amp; Pedicure</h5>
                                                        <p> 
                                                            Lorem Ipsum is simply dummy text. 
