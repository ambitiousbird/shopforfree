                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <td>
                                            <form class="form-horizontal">
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                    <a href="/forgetpass" style={{textDecoration:"underline"}}>Forgot password ?</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </td>
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    <div class="input-append"><
                                                        input class="span1" style={{maxWidth:"34px"}} placeholder="1" id="appendedInputButtons" size="16" type="text" />
                                                ...
                                                <td>
                                                    <div class="input-append">
                                                        <input class="span1" style={{maxWidth:"34px"}} placeholder="1"  size="16" type="text" />
                                                        <button class="btn" type="button"><i class="icon-minus"></i></button>
                                                        <button class="btn" type="button"><i class="icon-plus"></i></button>
                                                        <button class="btn btn-danger" type="button"><i class="icon-remove icon-white"></i></button>				
                                                    </div>
